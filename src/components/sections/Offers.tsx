        ...
        <section id="offers" className="min-h-screen bg-white relative pt-5">
            ...
            <div className="flex items-center justify-center bg-[#BEE5DB] w-fit mx-auto px-3 sm:px-5 py-3 sm:py-4 rounded-tl-4xl rounded-br-4xl border-[#1AAB86] border-2 shadow-2xl mt-16 sm:mt-20">
                ...
                <div className="text-center">
                    ...
                    <p className="text-lg sm:text-xl text-black/70 -mt-1">on all medicines</p>
                </div>
            </div>


            <div className="relative mx-auto mt-8 sm:mt-12 w-[95%] sm:w-[92%] max-w-6xl rounded-2xl border border-[#1AAB86] bg-white shadow-2xl overflow-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 px-4 sm:px-6 lg:px-10 pb-8 sm:pb-10 items-start">
                    ...
                    <div className="flex flex-col gap-1 text-center md:text-left">
                        <h3 className="text-xl sm:text-2xl lg:text-3xl font-extrabold text-black">Aved Sundari Beetroot Face Wash</h3>
                        <p className="text-black/70 text-sm sm:text-base">Enriched with Beetroot & Vitamin C</p>
                        ...
                        <div className="flex items-end justify-center md:justify-start gap-4 pt-1">
                            <span className="text-black/40 line-through text-lg sm:text-xl">₹1499</span>
                            <span className="text-[#1AAB86] font-extrabold text-xl sm:text-2xl">₹399</span>
                        </div>
                ...
                <div className="flex items-center gap-4 sm:gap-6 justify-center sm:justify-end px-4 sm:px-6 lg:px-10 pb-4 sm:pb-6 text-black/80">
                    <BsTwitterX className="cursor-pointer text-xl sm:text-2xl" />
                    <AiOutlineInstagram className="cursor-pointer text-2xl sm:text-3xl" />
                    <AiOutlineLinkedin className="cursor-pointer text-2xl sm:text-3xl" />
                    <AiOutlineWhatsApp className="cursor-pointer text-2xl sm:text-3xl" />
                    <AiOutlineLink className="cursor-pointer text-2xl sm:text-3xl" />
                </div>
            </div>
